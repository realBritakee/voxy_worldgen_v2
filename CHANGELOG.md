# Changelog - Voxy WorldGen V2 (1.21.1)

All changes to the Voxy WorldGen V2 mod for Minecraft 1.21.1.
...
### Added
- `/voxygen start` - resume background chunk generation
- `/voxygen stop` - pause background chunk generation
