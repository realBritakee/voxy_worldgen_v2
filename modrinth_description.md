...
| Mod | Version | Why |
|-----|---------|-----|
| [Voxy NeoForge](https://github.com/realBritakee/voxy-neoforge) | `1.20+` | The LoD rendering mod this companion supports. |
